...
declare module 'vscode' {
	...
	/**
	 * The VSCode version of the underlying editor.
	 */
	export const version: string;

	/**
	 * The Version of Kiro in use.
	 */
	export const kiroVersion: string;
	...
	/**
	 * Render options for a {@link CodeLens code lens}.
	 */
	export interface CodeLensRenderOptions {
		/**
		 * Color of code lens text.
		 */
		color?: string | ThemeColor;

		/**
		 * Size of code lens font in px.
		 */
		fontSize?: number;

		/**
		 * Font family of code lens text.
		 */
		fontFamily?: string;

		/**
		 * Size of code lens icon in px.
		 */
		iconSize?: number;

		/**
		 * Color of left border decoration
		 */
		borderColor?: string | ThemeColor;

		/**
		 * Size of indentation in px.
		 */
		indent?: number;

		/**
		 * Padding between actions associated with code lens in px.
		 */
	...
	export namespace env {
		...
		/**
		 * Options for opening external URIs.
		 */
		export interface OpenExternalOptions {
			/**
			 * Skip validation of the URI against trusted domains.
			 */
		 ...
		 * @param options Options to control the behavior of opening the link.
	...
	export class TreeItem {
		...
		/**
		 * The {@link Command} that should be executed when a tree item's button is clicked.
		 *
		 * Please use `vscode.open` or `vscode.diff` as command IDs when the tree item is opening
		 * something in the editor. Using these commands ensures that the resulting editor will
		 * appear consistent with how other built-in trees open editors.
		...
		/**
		 * The icon path or {@link ThemeIcon} associated with the tree item's button
		 */
		buttonIconPath?: string | Uri | {
			/**
			 * The icon path for the light theme
			 */
			light: string | Uri;
		...
		/**
		 * Text to display on the tree item's button instead of an icon.
		 * If both buttonText and buttonIconPath are provided, buttonText takes precedence.
		 */
		buttonText?: string;

		/**
		 * Class name to add for custom styling on the TreeItem container.
		 */
		className?: string;
