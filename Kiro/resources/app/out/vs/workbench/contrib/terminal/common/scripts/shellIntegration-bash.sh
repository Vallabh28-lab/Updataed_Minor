...
# This variable is unused in these scripts but some other tools rely on it to enable their side of
# shell integration (See https://github.com/microsoft/vscode/issues/146587 as example)
